...
urlpatterns = [
    ...
    path('ctUpdateStudentName/',   ca.CTUpdateStudentNameViewSet.as_view()),
    path('ctGetInactiveReasons/',  ca.CTGetInactiveReasonsViewSet.as_view()),
    path('ctGetTransferOptions/',  ca.CTGetTransferOptionsViewSet.as_view()),
